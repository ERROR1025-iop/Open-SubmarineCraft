...
{
    public class SignalButton : SolidBlock
    {
        ...
        public SignalButton(int id, GameObject parentObject, GameObject blockObject)
            : base(id, parentObject, blockObject)
        {
            initBlock("signalButton", "signal");
        ...
        {
            SignalButton block = new SignalButton(blockId, parentObject, blockObject);
